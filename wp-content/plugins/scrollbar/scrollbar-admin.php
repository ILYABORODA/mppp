<?php
	...
	<div class="wrap">
		<h2><?php echo __( 'Scrollbar Option Settings', 'scrolltop' ); ?></h2>
		<form method="post" action="">
			...
			<table class="form-table">
				<tr valign="top">
					...
					<span><?php echo __('Select scrollbar color', 'tpscrollbars'); ?>;</span>
					</td>
				</tr>
				<tr valign="top">
					...
					<span><?php echo __('Select scrollbar width .default width:5px', 'tpscrollbars'); ?></span>
					</td>
				</tr>
				<tr valign="top">
					...
					<span><?php echo __('Select scrollbar border radius .default border-radius:0px', 'tpscrollbars'); ?></span>
					</td>
				</tr>
				<tr valign="top">
					...
					<span><?php echo __('Select scrollbar scroll speed .default speed:60', 'tpscrollbars'); ?></span>
					</td>
				</tr>
				<tr valign="top">
					...
					<span><?php echo __('Select scrollbar border .default border:0px', 'tpscrollbars'); ?></span>
					</td>
				</tr>
				<tr valign="top">
					<th scope="row">
					...
					<td style="vertical-align:middle;">
						...
						<span><?php echo __('Enable/Disable scrollbar Auto Hide Mode', 'tpscrollbars'); ?></span>
					</td>
				</tr>
			</table>
			<p class="submit">
